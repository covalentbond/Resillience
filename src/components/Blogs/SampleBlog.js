...
function SampleBlog() {
  return parse(`<p class="ql-align-center">Hello</p><p class="ql-align-center">How are you</p><p class="ql-align-center"><br></p><blockquote><em>Yes i am fine</em></blockquote>
    `);
}
